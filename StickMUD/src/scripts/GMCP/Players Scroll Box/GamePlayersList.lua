...
local function filterByCoder(player)
  if isNumber(player.coder) and player.coder ~= 0 then
    return true
  end
  return false
end
...
function GamePlayersList()
  ...
  if #coders > 0 then
    ...
    gamePlayersList =
      gamePlayersList .. "<tr><td colspan=\"2\"><font size=\"3\" color=\"gray\">IMMORTALS - "
  ...
  if #players > 0 then
    ...
    gamePlayersList =
      gamePlayersList .. "<tr><td colspan=\"2\"><font size=\"3\" color=\"gray\">PLAYERS - "
    ...
    for k, v in pairs(players) do
      ...
      gamePlayersList =
        ...
        "</font>"
      gamePlayersList =
        gamePlayersList .. "<br><font size=\"3\" color=\"silver\">" .. firstToUpper(v.race)
  ...
  GUI.GamePlayersListLabel =
    Geyser.Label:new(
      {name = "GUI.GamePlayersListLabel", x = 0, y = 0, width = "100%", height = "200%"},
