  ...
  local tkeys = {}
	...
	for _, k in ipairs(tkeys) do
      ...
      function (v1, v2)
		...
		GUI["HelpLabel"..k]:echo("<center><font size=\"3\" color=\"yellow\">"..firstToUpper(k).."</font></center>")

		GUI["HelpLabel"..k]:setClickCallback("on_helplabel_press", k)
		
		if selected_help_topic == nil then
			selected_help_topic = k
		end
    ...
    if selected_help_topic == k then
    		...
    		cechoLink("GUI.HelpConsole", "<magenta>?<reset>", [[send("help ]] .. v2 .. [[", false)]], ("Help on " .. v2), true)
