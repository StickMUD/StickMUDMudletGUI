function RoomInfo()
	...
	GUI.BoxRoom:echo("<center><font size=\"4\">📍</font> <b><font size=\"3\">"..name.."</font></b></center>")
	...
	local directions = nil
 	...
 	if directions == nil then
		directions = "No obvious exits"
	end
 
 GUI.BoxExits:echo("<center><font size=\"4\">🚪</font> <b><font size=\"3\">"..directions.."</font></b></center>")
end