content_sections =
  {"BoxWieldedWeapons", "BoxWornArmour", "BoxInventory", "BoxRoomInv", "BoxMap", "BoxInfo"}
content_icons = {"⚔️", "🛡", "🎒", "📍", "🗺️", "ℹ️"}
content_tooltips = {"Weapon", "Armour️", "Carry", "Room", "Map", "Info"}
content_consoles =
  {
    "WieldedWeaponsConsole",
    "WornArmourConsole",
    "InventoryConsole",
    "RoomConsole",
    "MapperConsole",
...
GUI.HBoxContent =
  Geyser.HBox:new(
    {name = "GUI.HBoxContent", x = 0, y = "45%", width = "50%", height = "5%"}, GUI.Right
  )
...
GUI.ContentBox =
  Geyser.Label:new(
    {name = "GUI.ContentBox", x = 0, y = "50%", width = "50%", height = "39%"}, GUI.Right
  )
