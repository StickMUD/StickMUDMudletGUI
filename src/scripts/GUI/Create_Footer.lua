...
GUI.BoxRoom:echo("<center><font size=\"4\"><img src=\"" .. getMudletHomeDir() ..
                     "/StickMUD/047-user.png\"></font> <b><font size=\"3\">Room</font></b></center>")

GUI.BoxArea = Geyser.Label:new({name = "GUI.BoxArea"}, GUI.FooterBottom)
GUI.BoxArea:setStyleSheet(GUI.BoxFooterCSS:getCSS())
GUI.BoxArea:echo("<center><font size=\"4\"><img src=\"" .. getMudletHomeDir() ..
                     "/StickMUD/048-tour.png\"></font> <b><font size=\"3\">Area</font></b></center>")
